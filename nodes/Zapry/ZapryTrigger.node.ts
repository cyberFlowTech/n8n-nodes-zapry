...
export class ZapryTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Zapry Trigger',
		name: 'zapryTrigger',
		icon: 'file:zapry.svg',
		group: ['trigger'],
		version: [1, 1.1, 1.2],
		...
		description: 'Starts the workflow on a Zapry update',
		defaults: {
			name: 'Zapry Trigger',
		},
		inputs: [],
		...
		properties: [
			{
				displayName:
					'Due to Zapry API limitations, you can use just one Zapry trigger for each bot at a time',
				name: 'zapryTriggerNotice',
				type: 'notice',
				default: '',
			},
			{
				...
				options: [
					{
						...
						description:
							"Zapry delivers the image in multiple sizes. By default, just the large image would be downloaded. If you want to change the size, set the field 'Image Size'.",
					},
					{
