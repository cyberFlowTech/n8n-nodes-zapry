...
const preBuiltAgentsCallout: INodeProperties = {
	...
	displayName: 'Interact with Zapry using our pre-built',
	name: 'preBuiltAgentsCalloutZapry',
	type: 'callout' as NodePropertyTypes,
	typeOptions: {
		calloutAction: {
			label: 'Voice assistant agent',
			icon: 'bot',
			type: 'openSampleWorkflowTemplate',
			templateId: 'voice_assistant_agent_with_zapry',
		},
	},
	default: '',
};

export class Zapry implements INodeType {
	description: INodeTypeDescription = {
		...
		description: 'Sends data to Zapry',
		defaults: {
			name: 'Zapry',
		},
		usableAsTool: true,
		...
		properties: [
			...
			// ----------------------------------
			{
				...
				description:
					'Animation to send. Pass a file_id to send an animation that exists on the Zapry servers (recommended), an HTTP URL for Zapry to get an animation from the Internet.',
			},
			...
			// ----------------------------------
			{
				...
				description:
					'Audio file to send. Pass a file_id to send a file that exists on the Zapry servers (recommended), an HTTP URL for Zapry to get a file from the Internet.',
			},
			...
			// ----------------------------------
			{
				...
				description:
					'Document to send. Pass a file_id to send a file that exists on the Zapry servers (recommended), an HTTP URL for Zapry to get a file from the Internet.',
			},
				...
				options: [
					{
						...
						values: [
							...
							},
							{
								...
								default: '',
								description:
									'Media to send. Pass a file_id to send a file that exists on the Zapry servers (recommended) or pass an HTTP URL for Zapry to get a file from the Internet.',
							},
							{
								displayName: 'Additional Fields',
								name: 'additionalFields',
			...
			// ----------------------------------
			{
				...
				description:
					'Photo to send. Pass a file_id to send a photo that exists on the Zapry servers (recommended), an HTTP URL for Zapry to get a photo from the Internet.',
			},
			...
			// ----------------------------------
			{
				...
				description:
					'Sticker to send. Pass a file_id to send a file that exists on the Zapry servers (recommended), an HTTP URL for Zapry to get a .webp file from the Internet.',
			},
			...
			// ----------------------------------
			{
				...
				description:
					'Video file to send. Pass a file_id to send a file that exists on the Zapry servers (recommended), an HTTP URL for Zapry to get a file from the Internet.',
			},
											...
											},
											{
												...
												options: [
													...
													},
													{
														...
														name: 'web_app',
														type: 'collection',
														placeholder: 'Set Zapry Web App URL',
														typeOptions: {
														...
														description: 'Launch the Zapry Web App',
													},
												],
											},
										],
			...
			try {
				...
				if (resource === 'file' && operation === 'get') {
					if (this.getNodeParameter('download', i, false)) {
						...
						const credentials = await this.getCredentials('zapryApi');
